...
@implementation MATextBank

// https://stackoverflow.com/a/56656/1198964
+ (NSArray *)shuffleArr:(NSMutableArray *)arr {
...
// https://www.pastemagazine.com/blogs/lists/2013/02/best-dwight-shrute-quotes.html
+ (NSArray<NSString*> *)randomizedTextBank {
    NSMutableArray* arr = [@[@"Would I ever leave this company? Look, I’m all about loyalty. In fact, I feel like part of what I’m being paid for here is my loyalty. But if there were somewhere else that valued loyalty more highly… I’m going wherever they value loyalty the most.",
    ...
    return [MATextBank shuffleArr:arr];
}
